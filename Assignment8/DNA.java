 ...
 * Some portions are the same for all humans and some are more distinct based on
 * parentage.
 * 
 * To identify parents and relatives we can look at STRs (Short Tandem Repeats)
 * within the DNA sequence.
 * STRs are short DNA segments that repeat back-to-back in DNA squences numerous
 * times.
 * 
...
public class DNA {
     ...
     *
     * Input file format:
     * - 1 line containing an integer, p, with the number of profiles/people in the
     * file
     ...
     * - 1 line containing the second sequence of STRs that comes from the other
     * parent
     *
     * Approach:
     * 1. Create the database array to hold the profiles (don’t forget about the
     * instance variables)
    ...
    public void createDatabaseOfProfiles(String filename) {
        ...
        for (int i = 0; i < p; i++) {
            ...
            String Seq1 = StdIn.readString();
            String Seq2 = StdIn.readString();
            database[i] = new Profile(name, null, null, Seq1, Seq2);
        }
    }

    /**
     * Creates and populates the STRsOfInterest array with STRs from the input file,
     * filename.
     * 
     * Input file format:
     ...
     * 
     * Approach:
     * 1. Create the STRsOfInterest array to hold the STRs (don't forget about the
     * instance variable)
    ...
    /**
     * Creates and return the profile for the unknown DNA sequence from the input
     * file, filename.
     * 
     * Input file format:
    ...
    public Profile createUnknownProfile(String filename) {
        ...
        return new Profile(profileName, null, null, sequence1, sequence2);// update return statement with Profile object
    }
     ...
     * 
     * Approach:
     * 1. Similar strategy used in createDatabaseOfProfiles and
     ...
     * 2. for each profile in the database whose sequence1 matches
     * unknownProfilesS1_STRs:
     * a. add to ArrayList
    ...
    public ArrayList<Profile> findMatchingProfiles(STR[] unknownProfileS1_STRs) {
        ...
        // YOUR CODE HERE
        ArrayList<Profile> matchProfiles = new ArrayList<>();
        ...
        // update return statement with ArrayList
    }
